...
+~~Developer By : @devss_bot On Telegram ,
...
git clone https://github.com/Joker-Developer/Joker-Developer.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf Joker-Developer && rm -rf .telegram-cli && git clone https://github.com/Joker-Developer/Joker-Developer.git && cd Joker-Developer && ./launch.sh install && ./launch.sh
~~~~~
